...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.requestClientCert":
		if e.complexity.Mutation.RequestClientCert == nil {
			break
		}

		args, err := ec.field_Mutation_requestClientCert_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}
	...
	case "Mutation.requestHTTPSCert":
		...
		args, err := ec.field_Mutation_requestHTTPSCert_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}
