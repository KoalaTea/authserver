...
// UpdateSessionToken sets the "SessionToken" field to the value that was provided on create.
...
// UpdateIsActivated sets the "IsActivated" field to the value that was provided on create.
